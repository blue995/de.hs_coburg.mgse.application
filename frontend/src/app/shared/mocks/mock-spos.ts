...
export const SPOS: Spo[] = [
    ...
    paragraphs: [
      {
        ...
        text: [
          {
            text: 'Zweck der Studien– und Prüfungsordnung\n' +
            '1Diese Studien– und Prüfungsordnung regelt\n' +
  ...
  {
    shortName: 'SPO M IF 1',
    title: 'Studien- und Prüfungsordnung für den Bachelorstudiengang Informatik\n' +
    'an der Hochschule für angewandte Wissenschaften Coburg (SPO M IF)',
    validity: 'Vom 25. Juni 2018',
    courseOfStudy: {
      name: 'Informatik',
      ects: 210,
      semesters: 7,
      ...
      faculty: { name: 'Elektrotechnik & Informatik', shortName: 'E/INF'},
      degree: { glossaryEntry: {word: 'Master of Science', abbreviation: 'M. Sc.'} }
    },
    preface: 'Auf Grund von Art.13 Abs.1, 43, 44, 58 Abs.1, 61 Abs.2 und 8 und 66 des Bayerischen Hochschulgesetzes\n' +
    '–BayHSchG– (BayRS 2210–1–1–WFK) erlässt die Hochschule für angewandte\n' +
    'Wissenschaften Coburg folgende Satzung:',
  ...
  {
    shortName: 'SPO B ET 1',
    title: 'Studien- und Prüfungsordnung für den Bachelorstudiengang Elektrotechnik\n' +
    'an der Hochschule für angewandte Wissenschaften Coburg (SPO B ET)',
    validity: 'Vom 25. Juni 2014',
    courseOfStudy: {
      name: 'Elektrotechnik',
      ects: 210,
      ...
      requirements: 'Abitur',
      faculty: { name: 'Elektrotechnik & Informatik', shortName: 'E/INF'},
      degree: { glossaryEntry: {word: 'Bachelor of Engineering', abbreviation: 'B. Eng.'} }
    },
    preface: 'Auf Grund von Art.13 Abs.1, 43, 44, 58 Abs.1, 61 Abs.2 und 8 und 66 des Bayerischen Hochschulgesetzes\n' +
    '–BayHSchG– (BayRS 2210–1–1–WFK) erlässt die Hochschule für angewandte\n' +
    'Wissenschaften Coburg folgende Satzung:',
