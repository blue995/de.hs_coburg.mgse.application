...
class DegreeMeta {
  ...
  courseCatalogues: Curriculum[];       // list of curricula (can be empty, but must be included
}

class Curriculum {
  catalogueId: number;                  // e.g.: "1" or whatever you defined as curriculum id (used to call it for detail view)
