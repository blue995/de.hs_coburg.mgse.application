	...
	public static boolean createModel() {
		...
		try {
			...
			if (curriculum_entry != null) {
				...
				//module_desc.setAdmissionRequirements([de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.ModuleAdmissionRequirementImpl@2eb48684 (text: keine)]);
				//module_desc.setWorkloads([de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.WorkloadImpl@1b52cb34 (description: Präsenz  (30 h Seminaristischer Unterricht, 30 h Übung), effort: 60), de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.WorkloadImpl@2d7b78b4 (description: Eigenarbeit (30h Vor- und Nachbereitung des Lehrstoffs, 30h Lösung von Übungsaufgaben, 30h Prüfungsvorbereitung), effort: 90)]);
			...
			if (curriculum_entry != null) {
				...
				if (lecture_list != null && lecture_list.size() > 0) module_desc.setLectures(lecture_list);
				//module_desc.setAdmissionRequirements([de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.ModuleAdmissionRequirementImpl@399315cf (text: keine)]);
				//module_desc.setWorkloads([de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.WorkloadImpl@787832a (description: Präsenz (Seminaristischer Unterricht: 60 h, Übung: 60 h), effort: 90), de.hs_coburg.mgse.platform.modulehandbook.moduleHandbookModel.impl.WorkloadImpl@d8da5f8 (description: Eigenarbeit (Nachbereitung Seminaristischer Unterricht: 40 h, Übung: 30 h, Prüfungsvorbereitung: 50 h), effort: 120)]);
				//module_desc.setMedias([Tafel, Skript]);
